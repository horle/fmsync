...
CREATE TABLE `test` (
  `PS_TestID` mediumint(9) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `lastModified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`PS_TestID`)
...
INSERT INTO `test` VALUES (1,'HansMans','2017-04-17 17:49:39'),(2,'OttoMotto','2017-04-17 17:49:38'),(3,'Test','2017-04-17 17:49:37');
